...
const PRODUCTS = [
    { id: 1, title: "Iced Brown Sugar Oatmilk Espresso", category: "Coffee", price: 5.95, featured: true, rating: 4.9, img: "https://images.unsplash.com/photo-1517701604599-bb29b565090c?auto=format&fit=crop&q=80&w=300", desc: "First-class Starbucks Blonde Espresso shots shaken violently with complex brown sugar and cinnamon, topped elegantly with creamy oatmilk." },
    { id: 2, title: "Caramel Frappuccino Blended Coffee", category: "Frappuccino", price: 5.45, featured: true, rating: 4.8, img: "https://images.unsplash.com/photo-1572490122747-3968b75cc699?auto=format&fit=crop&q=80&w=300", desc: "Buttery caramel syrup combined flawlessly with premium roast coffee, milk, and crushed ice, completely finished with whipped cream peaks." },
    { id: 3, title: "Matcha Tea Latte", category: "Tea", price: 4.95, featured: true, rating: 4.7, img: "https://images.unsplash.com/photo-1536256263959-770b48d82b0a?auto=format&fit=crop&q=80&w=300", desc: "Smooth and creamy sweetened stone-ground Japanese matcha green tea leaves whisked perfectly into steamed choice whole milk variants." },
    { id: 4, title: "Caffè Latte", category: "Coffee", price: 4.65, featured: false, rating: 4.6, img: "https://images.unsplash.com/photo-1541167760496-1628856ab772?auto=format&fit=crop&q=80&w=300", desc: "Our dark, rich signature espresso balanced masterfully with silky smooth steamed milk and topped with a delicate layer of microfoam." },
    ...
    { id: 6, title: "Butter Croissant", category: "Bakery", price: 3.75, featured: false, rating: 4.8, img: "https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=80&w=300", desc: "Classic golden, multi-layered puff pastry engineered cleanly using absolute 100% real butter ingredients for absolute flakiness." }
];
